...
import com.ty.highway.frameworklibrary.support.zxing.camera.CameraManager;
import com.ty.highway.frameworklibrary.support.zxing.decoding.CaptureActivityHandler;
import com.ty.highway.frameworklibrary.support.zxing.decoding.InactivityTimer;
import com.ty.highway.frameworklibrary.support.zxing.decoding.QrcodeFileDecoder;
import com.ty.highway.frameworklibrary.support.zxing.view.ViewfinderView;
...
public class CaptureActivity extends BaseActivity implements Callback {
	...
	public void handleDecode(Result obj, Bitmap barcode) {
		...
		if (url != null && url.length() > 0) {
			...
			url = url.replaceAll("amp;", "");// 草料二维码带有特殊字符amp;
