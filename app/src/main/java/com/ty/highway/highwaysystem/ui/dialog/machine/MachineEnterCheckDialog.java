 ...
 */
public class MachineEnterCheckDialog extends BaseDialog implements View.OnClickListener, AdapterView.OnItemSelectedListener, CompoundButton.OnCheckedChangeListener {
    ...
    public MachineEnterCheckDialog(Context context, ELMachineTaskBean mTaskInfoBean) {
        super(context, R.style.mDialog);
        this.mTaskInfoBean = mTaskInfoBean;
        mContext = context;
    }

    public MachineEnterCheckDialog(Context context, int themeResId) {
    ...
    private boolean updateTask() {
        ...
        DBELMachineTaskDao.getInstance(getContext()).updateTask(mTaskInfoBean, PreferencesUtils.getString(mContext, Constants.SP_USER_ID));
        return true;
    }
